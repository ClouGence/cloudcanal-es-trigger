...
import com.clougence.cloudcanal.es7.trigger.ds.Es7ClientHelper;
...
public class CcEs7MetaServiceImpl implements CcMetaService {

    private static final Logger log = LoggerFactory.getLogger(CcEs7MetaServiceImpl.class);
